...
city_manager: city_manager.c utils.c commands.c report.h utils.h commands.h
...
city_hub: city_hub_main.c city_hub.c city_hub.h report.h
	$(CC) $(CFLAGS) city_hub_main.c city_hub.c -o city_hub
